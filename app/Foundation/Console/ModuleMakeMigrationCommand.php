...
{
    protected $signature = 'module:make:migration {module} {name} {--dry-run} {--force}';
    ...
    {
        try {
            $g->plan($p, $this->argument('module'), 'migration', $this->argument('name'));
        } catch (\Throwable $e) {
        ...
        return $this->runPlan($p, 'module:make:migration');
    }
}
